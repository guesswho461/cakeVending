...
class CheckoutItemTable2 extends React.Component {
  render() {
      ...
      <Paper className={classes.root}>
        <Table className={classes.table}>
          ...
          <TableBody>
            ...
            <TableRow>
              <TableCell colSpan={3} align="right">總計</TableCell>
              <TableCell align="right">{companyInfo.currency}${this.props.checkoutItem.totalPrice}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell colSpan={3} align="right">已投幣</TableCell>
              <TableCell align="right">{companyInfo.currency}${this.props.mqttTopics.coinValue}</TableCell>
            </TableRow>
          </TableBody>
        </Table>
      </Paper>
...
export default connect(
  mapStateToProps,
  null
)(withStyles(styles)(CheckoutItemTable2));
